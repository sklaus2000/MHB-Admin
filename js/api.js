...
async function apiSaveOpeningHours(openingTime, closingTime) {

  return await postJson({

    action: "adminUpdateOpeningHours",
...
async function apiSaveWebsiteSettings(settings) {

  return await postJson({

    action: "adminUpdateWebsiteSettings",
